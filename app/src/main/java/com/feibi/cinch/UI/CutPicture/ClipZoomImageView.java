...
public class ClipZoomImageView extends ImageView implements
	...
	private int getHVerticalPadding() {
		return (getHeight() - ((getWidth() - 2 * mHorizontalPadding)*ClipImageLayout.y/ClipImageLayout.x)) / 2;
	}
	private int getCropHeight() {
		return ((getWidth() - 2 * mHorizontalPadding)*ClipImageLayout.y/ClipImageLayout.x);
	}
}
