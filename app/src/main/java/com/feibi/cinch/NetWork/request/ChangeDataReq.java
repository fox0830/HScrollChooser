...
public class ChangeDataReq {
    ...
    public ChangeDataReq(String mb_no, String lc_id, String lc_name, String lc_tel, String lc_age, String lc_sex, String lc_tall, String lc_weight, String lc_bmi, String lc_fat, String lc_target, String lc_remark) {
        this.mb_no = mb_no;
        this.lc_id = lc_id;
